...
public interface ContactManager {
     ...
     *
     * An ID is returned when the meeting is put into the system. This ID must be
     ...
     *   past, or if any contact is unknown/non-existent.
    ...
    /**
     * Returns the list of past meetings in which this contact has
     * participated.
     *
     * If there are none, the returned list will be empty. Otherwise, the list
     * will be chronologically sorted and will not contain any duplicates.
     ...
     * converted to a past meeting (with notes) and returned.
     *
     ...
     *   provided IDs does not correspond to a real contact.
     */
